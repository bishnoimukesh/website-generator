...
export const Footer = ({ config = defaultFooterConfig }: FooterProps) => {
  return (
    <footer className="container w-full border-t bg-background 2xl:max-w-5xl">
      <div className="mx-auto px-4 md:px-6 flex flex-col items-center justify-between gap-4 py-10 md:h-24 md:flex-row md:py-0">
